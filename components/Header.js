    ...
    return (
        <header
         className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10">
            {/* Left */}
            <div
             className="relative flex items-center h-10 cursor-pointer my-auto active:scale-90 transition duration-150">
                <Image 
            ...
            <div
             className="flex items-center md:border-2 rounded-full py-2 md:shadow-sm  ">
                <input
                 ...
                 className=" flex-grow pl-5 bg-transparent outline-none text-sm text-gray-600 placeholder-gray-400 active:scale-90 transition duration-50 " type="text" placeholder="Start your Search"
                 />
                 <SearchIcon
            ...
            <div
             className="flex items-center space-x-4 justify-end text-gray-500">
                <p
                 className="cursor-pointer hidden md:inline hover:text-red-400 active:scale-90 transition duration-150">Become a Host</p>
                <GlobeAltIcon className="h-6  " />

                <div
                 className="flex items-center space-x-2 border-2 p-2 rounded-full cursor-pointer group active:scale-90 transition duration-150">
                    <MenuIcon
                     className="h-6 cursor-pointer group-hover:text-red-400   " />
                    <UserCircleIcon
                     className="h-6 cursor-pointer group-hover:text-red-400   " />
                </div>
            </div>
